...
function BaseForm(props) {
  ...
  var transformKey = function transformKey(values, omit, parentKey) {
    return (0, _proUtils.transformKeySubmitValue)((0, _proUtils.conversionSubmitValue)(values, dateFormatter, fieldsValueType.current, omit, parentKey), transformKeyRef.current);
  };
...
function RequestForm(props) {
  var request = props.request,
      ...
      rest = _objectWithoutProperties(props, ["request", "params", "initialValues"]);
